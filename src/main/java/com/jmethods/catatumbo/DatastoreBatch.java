...
public interface DatastoreBatch {
   ...
   * time of this batch. Generated keys can be retrieved using {@link
   * DatastoreBatch.Response#getGeneratedKeys()}.This method throws {@link EntityManagerException}
   * if the entity is using a String identifier. String identifiers are allocated at add time,
   * instead of submit time. For entities with String identifiers, use the {@link
   * DatastoreBatch#insert(Object)} method.
   *
   * @param entity the entity to insert
   * @throws EntityManagerException if the entity has a String identifier or if any error occurs
   */
   ...
   * submit time of this batch. Generated keys can be retrieved using {@link
   * DatastoreBatch.Response#getGeneratedKeys()}.This method throws {@link EntityManagerException}
   * if the entity is using a String identifier. String identifiers are allocated at add time,
   * instead of submit time. For entities with String identifiers, use the {@link
   * DatastoreBatch#insert(List)} method.
   *
   * @param entities the entities to insert
   * @throws EntityManagerException if the entity have a String identifier any error occurs
   */
   ...
   * will be deferred to the submit time of this batch. This method throws an {@link
   * EntityManagerException} if the entity is using a String ID. Entity with String ID should use
   * {@link DatastoreBatch#upsert(Object)} method.
   *
   * @param entity the entity to update or insert
   * @throws EntityManagerException if the entity has a String ID or any other error occurs while
   ...
   * will be deferred to the submit time of this batch. This method throws an {@link
   * EntityManagerException} if the entities have String identifiers. Entities with String
   * identifiers should use {@link DatastoreBatch#upsert(List)} method.
   *
   * @param entities the entities to update or insert
   * @throws EntityManagerException if the entities have String identifiers or any other error
   ...
   * @throws EntityManagerException if any error occurs
   */
  Response submit();
