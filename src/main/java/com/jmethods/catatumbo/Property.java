...
/**
 * Specifies the mapped property for a persistable field. It is not necessary to have this
 * annotation on every field of the entity. By default, all field declared in the entity are treated
 * as persistable, unless they are marked with {@link Ignore} annotation.
 *
...
public @interface Property {
  ...
  /**
   * Specifies the name of the property in the Cloud Datastore. If not specified, the field name is
  ...
  /**
   * Specifies whether or not the property is optional. When optional is set to <code>true</code> on
   * a field of an {@link Entity}, {@link MappedSuperClass} or {@link Embeddable}, and if the field
