 ...
 * (read/write) within a transaction. Transactions are committed with the call to {@link
 * DatastoreTransaction#commit()} method. Transactions can be rolled back with a call to {@link
...
public interface DatastoreTransaction extends DatastoreAccess {
   ...
   * @throws EntityManagerException if the entity has a String Identifier or any other error occurs
   *     while accessing the underlying Datastore.
   */
   ...
   * key, if any, can be retrieved by calling {@link
   * DatastoreTransaction.Response#getGeneratedKeys()}.
   *
   ...
   * keys, if any, can be retrieved by calling {@link
   * DatastoreTransaction.Response#getGeneratedKeys()}.
   *
   ...
   * @throws EntityManagerException if the commit fails.
   */
  Response commit();
   ...
   *
   * @throws EntityManagerException if this transaction was already committed.
   */
  void rollback();
