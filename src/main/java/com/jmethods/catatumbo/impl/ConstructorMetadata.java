...
public class ConstructorMetadata {
  ...
  /** The construction strategy to use for creating/building instances of this persistence class */
  private final ConstructionStrategy constructionStrategy;
  /**
   * A method handle for getting an instance of the persistence class. This method handle may be a
   * handle to the default constructor or to the static newBuilder method.
   */
  private final MethodHandle constructorMethodHandle;
  /** Builder class, if construction strategy is BUILDER */
  private final Class<?> builderClass;
  /** A method handle for building the final persistence object when using the BUILDER strategy. */
  private final MethodHandle buildMethodHandle;

  /**
   * Creates a new instance of {@code ConstructionMetadata}.
   *
   * @param builder the {@code Builder} from which to create this metadata
   */
  ...
  /**
   * Creates and returns a new {@link Builder} for building a {@link ConstructorMetadata}.
   *
  ...
  /**
   * Returns the strategy used for constructing/building instances of the model class to which this
   * metadata belongs.
   *
   * @return the strategy used for constructing/building instances of the model class to which this
   *     metadata belongs.
   */
  ...
  /**
   * Returns the method handle for constructing a new instance of model class or its Builder class.
   *
   * @return the methodHandle the method handle for constructing a new instance of model class or
   *     its Builder class.
   */
   ...
   *
   * @return the Builder class for the class to which this metadata belongs. May be {@code null}, if
   *     not using the BUILDER strategy.
   */
  ...
  /**
   * Returns the method handle for building the final persistence object from its Builder.
   *
   * @return the method handle for building the final persistence object from its Builder. May be
   *     {@code null}, if not using the Builder strategy.
   */
  ...
  /**
   * Tells whether or not the persistence class represented by this metadata using the {@link
   * ConstructionStrategy#CLASSIC} strategy.
   *
   * @return {@code true} if the persistence class using the {@link ConstructionStrategy#CLASSIC}
  ...
  /**
   * Tells whether or not the persistence class represented by this metadata using the {@link
   * ConstructionStrategy#BUILDER} strategy.
   *
   * @return {@code true} if the persistence class using the {@link ConstructionStrategy#BUILDER}
   *     strategy; {@code false}, otherwise.
   */
  ...
  /**
   * The strategy to use for constructing/instantiating/building a persistence object
   *
   * @author Sai Pullabhotla
   */
  public enum ConstructionStrategy {
     ...
     * standard Java Beans convention.
     */
    CLASSIC,

    /**
     * Builder design pattern - if the persistence class does not have a public no-arg constructor,
     * but has a static newBuilder/builder method.
     */
    BUILDER
  }
  ...
  public static class Builder {
     ...
     *
     * @param clazz the persistence class.
     ...
     *
     * @param constructionStrategy the construction strategy.
    ...
    /**
     * Sets the method handle for constructing the persistence object or its builder object.
     *
     * @param constructorMethodHandle the method handle for constructing the persistence object or
     *     its builder object.
     * @return this {@code Builder} instance
     */
    ...
    /**
     * Sets the method handle for building the persistence object from its builder.
     *
     * @param buildMethodHandle the method handle for building the persistence object from its
     *     builder.
     * @return this {@code Builder} instance
     */
    ...
    /**
     * Creates and returns a new {@link ConstructorMetadata} from this {@code Builder}'s state.
     *
     * @return a new {@link ConstructorMetadata} from this {@code Builder}'s state.
     */
